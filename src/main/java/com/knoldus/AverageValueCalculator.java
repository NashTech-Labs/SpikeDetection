...
public class AverageValueCalculator extends ProcessWindowFunction<SensorMeasurement, AverageValue, Integer, TimeWindow> {
    @Override
    public void process(Integer integer, ProcessWindowFunction<SensorMeasurement, AverageValue, Integer, TimeWindow>.Context context, Iterable<SensorMeasurement> elements, Collector<AverageValue> out) throws Exception {
        int sensorId = -1;
